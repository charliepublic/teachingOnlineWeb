    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var i = 0; i < arr.length; i++) {
                content += '<div class="container-fluid  border" style="padding-top:70px; padding-bottom:70px"><div><h4>教学计划：<span id="plan_name">' + arr[i].planName.replace(/\..{3}$/g,'') + '</span></h4></div><br><div><h5>策划人：<span id="plane_people">' + arr[i].teacherName +
